...
const Footer = () => {
    return (
        <footer className="footer p-10 bg-neutral text-neutral-content">
            <div>
                <img className='bg-white rounded-2xl' src="/assets/storyteller-logo.png" alt="" />
                <p>Storyteller<br /><span className='flex items-center gap-2'> <FaRegCopyright></FaRegCopyright> Copyright 2022,</span> All rights reserved.</p>
            </div>
            <div>
